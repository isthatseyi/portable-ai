...
- **Windows:** Place `ollama.exe` in `resources/` (download from [ollama.com/download](https://ollama.com/download))

See `package.json` → `build.mac.extraResources` and `build.win.extraResources` for the expected paths.

## License

Proprietary — Copyright © 2024-2026 Sammuel Oluwaseyi Johnson. All rights reserved.
